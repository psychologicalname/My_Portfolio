  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_2eyi6w4',
      {
        ...
        to_email: 'agrawal.pooja101@gmail.com',
        ...
        >
          <label className='flex flex-col'>
            ...
            <input
              ...
              className='bg-tertiary py-4 px-6 placeholder:text-secondory text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
